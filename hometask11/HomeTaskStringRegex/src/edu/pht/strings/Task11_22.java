...
public class Task11_22 {
	...
	public static void main(String[] args) {
		...
		String text = "public static void main(String[] args) {\r\n" + "" + "      /**\r\n"
				...
				+ "				.collect(Collectors.toList());\r\n"
				+ "//КОММЕНТЫ МОГУТ БЫТЬ В ЛЮБОМ МЕСТЕ - System.out.println(listNewNew);\r\n"
				...
				+ "		// найти все элементы массива, длина которых больше 1;//КОММЕНТЫ МОГУТ БЫТЬ В ЛЮБОМ МЕСТЕ - System.out.println(listNewNew);\r\n"
