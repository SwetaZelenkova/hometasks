...
public class Task11_18 {
	...
	public static void main(String[] args) {
		...
		String text = "жОсновным отличием StringBuildddder__ от StringBuffer является потокобезопасность последнего. "
				...
				+ "объекта в конкурирующщщщщщщих потоках";
		int count;
		String regex = "[\\P{L}]+";
		String[] words = text.split(regex);
		char[] chars = { 'б', 'в', 'г', 'д', 'ж', 'з', 'к', 'л', 'м', 'н', 'п', 'р', 'с', 'т', 'ф', 'х', 'ц', 'ч', 'ш',
