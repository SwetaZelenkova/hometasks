package edu.pht.cucumberjunit.pages;
...
public class LoginPage extends AbstractPage {
	...
	private static final String WRONG_NAME_OR_PASSWORD = "Неверное имя или пароль";
	...
	public boolean isMessageErrorPresents() {
		return waitUntilDisplayedTextInElement(messageError, WRONG_NAME_OR_PASSWORD);
	}
